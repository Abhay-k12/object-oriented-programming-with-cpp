/*31. Design and implement a system that allows users to manage student records by performing   
operations such as adding, searching, deleting, and displaying records. Use file handling to store 
and manipulate data persistently in a text file.*/
#include <iostream> 
#include <fstream> 
#include <cstring> 
using namespace std; 
